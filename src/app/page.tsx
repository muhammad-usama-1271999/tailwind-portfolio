        ...
        <div className="bg-black ">
            ...
            <div className="lg:flex justify-around lg:flex-row-reverse ">
              ...
              <div className="grid place-content-center py-24">
                ...
                <p className="text-white text-3xl font-bold mt-3">I Am <span className="text-green-400 text-5xl font-extrabold"><i>USAMA</i></span></p>
                <p className="text-white text-3xl font-bold mt-4">A <span className="text-green-400 text-5xl font-bold">Frontend Developer</span></p>
            ...
            <div className="grid place-content-center mb-3 mt-24 mx-4">
              ...
              <div className="mt-10">
                <p className="text-white text-2xl mb-3">My Academy
